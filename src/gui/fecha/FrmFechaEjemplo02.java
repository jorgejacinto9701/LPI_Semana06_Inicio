...
public class FrmFechaEjemplo02 extends JFrame implements ActionListener {
	...
	/**
	 * Caso 2 al cargar el formulario se desea 
	 * Fecha Inicio => La fecha actual
	 * Fecha Fin => el 31 de diciembre del año en curso
	 */
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					FrmFechaEjemplo02 frame = new FrmFechaEjemplo02();
